...
static double a1_x = (-1)*(0*2);
static double a1_y = (-1)*(1*2);
static double a2_x = (-1)*(2*2);
static double a2_y = (-1)*(3*2);
static double a3_x = (-1)*(3*2);
static double a3_y = (-1)*(1*2);
static double a1_const = (pow(0,2)) + (pow(1,2));
static double a2_const = (pow(2,2)) + (pow(3,2));
static double a3_const = (pow(3,2)) + (pow(1,2));
...
>>>>>>> fb3869077ee9741bc35d828af4e0708ffe988db5
}
